...
public class PlayerController : MonoBehaviour
{
    ...
    private void PickupBody()
    {
        ...
        _nearbyAgent.GetComponentsInChildren<Image>().ToList().ForEach(img => img.gameObject.SetActive(false));
        _nearbyAgent.GetComponentsInChildren<Collider>().ToList().ForEach(col => col.enabled = false);
        _nearbyAgent.GetComponentsInChildren<Rigidbody>().ToList().ForEach(rb => rb.isKinematic = true);
